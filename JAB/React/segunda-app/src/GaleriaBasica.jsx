...
function GaleriaBasica() {
    const [imagenes, setImagenes] = useState([
        { src: 'imgs/img1.jpg', alt: 'Imagen 1', caption: 'Pie de foto Imagen 1' },
        { src: 'imgs/img2.jpg', alt: 'Imagen 2', caption: 'Pie de foto Imagen 2' },
        { src: 'imgs/img3.jpg', alt: 'Imagen 3', caption: 'Pie de foto Imagen 3' },
        { src: 'imgs/img4.jpg', alt: 'Imagen 4', caption: 'Pie de foto Imagen 4' }
      ]);
